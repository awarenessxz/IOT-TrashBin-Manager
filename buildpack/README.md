This build pack is referenced from [Alexey Timanovsky's subdir-heroku-buildpack](https://github.com/timanovsky/subdir-heroku-buildpack) with minor adjustments. All credits goes to him.
